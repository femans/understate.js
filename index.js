...
String.prototype._ = function(){
    ...
    var position = -1;
    var r = this;
    var r = r.replace(/(\/)?_(\d+)(\/)?_/g, function(_, $0,$1,$2){return $0||$2?_:args[$1-1]||''})
             .replace(/(\/)?_/g, function(_, slash){return slash?_:args[++position]||keep_in_place?_:''});
    return r;
}

function testRunner(countertest){
    var counter = 1;
    function test(string, exp){
        return counter++ + ': '+(string==exp) +': '+string+ ' - '+exp;
    }
